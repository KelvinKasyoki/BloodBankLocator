...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO donors (username, age, mobileno, gender, emailaddress, bloodgroup, Bloodbank) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  <table align="center" width="40">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Bloodbank:</td>
       <td><input type="text" name="bloodbank" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">&nbsp;</td>
      <td><input type="submit" value="order blood" /></td>
    </tr>
  </table>
